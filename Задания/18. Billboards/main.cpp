...
int main( void )
{
	...
	window = glfwCreateWindow( 512, 384, "Billboards", NULL, NULL);
	if( window == NULL ){
	...
	GLuint cubeVertexPosition_modelspaceID = glGetAttribLocation(cubeProgramID, "vertexPosition_modelspace");
	GLuint cubeVertexColorID = glGetAttribLocation(cubeProgramID, "vertexColor");
	...
	do
	{
		...
		glEnableVertexAttribArray(cubeVertexPosition_modelspaceID);
		glBindBuffer(GL_ARRAY_BUFFER, cubevertexbuffer);
		glVertexAttribPointer(cubeVertexPosition_modelspaceID, 3, GL_FLOAT, GL_FALSE, 0, (void*)0  );
		glEnableVertexAttribArray(cubeVertexColorID);
		glBindBuffer(GL_ARRAY_BUFFER, cubecolorbuffer);
		glVertexAttribPointer(cubeVertexColorID, 3, GL_FLOAT,  GL_FALSE, 0, (void*)0   );
		glDrawArrays(GL_TRIANGLES, 0, 12*3);
		glDisableVertexAttribArray(cubeVertexPosition_modelspaceID);
		glDisableVertexAttribArray(cubeVertexColorID);
#endif
